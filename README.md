...
use `14.0`, the series this branch is for.
...
```bash
git submodule add -b 14.0 https://github.com/Axivox/axivox-odoo.git axivox-odoo
...
```bash
git clone --branch 14.0 https://github.com/Axivox/axivox-odoo.git /opt/axivox-odoo
...
the same number reads as a `14.0` release on your server. Only that number
